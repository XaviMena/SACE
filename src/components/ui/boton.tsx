...
const estilosBoton = cva(
  "inline-flex items-center justify-center rounded-[0.5rem] px-3 py-2 text-[var(--tamano-ui)] font-semibold transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-acento)] focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
  {
    variants: {
      variante: {
        primaria:
